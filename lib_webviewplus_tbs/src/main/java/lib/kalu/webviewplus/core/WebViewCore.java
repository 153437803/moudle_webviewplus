 ...
 */
public class WebViewCore extends com.tencent.smtt.sdk.WebView implements WebViewImpl, Handler.Callback {

    public WebViewCore(Context context, boolean b) {
        super(context, b);
        initConfig(this);
        initBackground(this);
    ...
    public WebViewCore(Context context, AttributeSet attributeSet, int i, boolean b) {
    ...
    public WebViewCore(Context context, AttributeSet attributeSet, int i, Map<String, Object> map, boolean b) {
    ...
    @Override
    public void initConfig(@NonNull com.tencent.smtt.sdk.WebView webView) {
        ...
        if (null != webView) {
            ...
            // 设置滚动条的样式
            webView.setScrollBarStyle(com.tencent.smtt.sdk.WebView.SCROLLBARS_OUTSIDE_OVERLAY);
...
//        settings.setLayoutAlgorithm(com.tencent.smtt.sdk.WebSettings.LayoutAlgorithm.SINGLE_COLUMN);
            ...
            // 提高网页渲染的优先级
            settings.setRenderPriority(com.tencent.smtt.sdk.WebSettings.RenderPriority.HIGH);
            // 启用还H5的地理定位服务
            ...
            // settings.setMixedContentMode(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? com.tencent.smtt.sdk.WebSettings.MIXED_CONTENT_COMPATIBILITY_MODE : com.tencent.smtt.sdk.WebSettings.LOAD_DEFAULT);
    ...
    @Override
    public void initBackground(@NonNull com.tencent.smtt.sdk.WebView webView) {
    ...
    @Override
    public void initWebViewClient(@NonNull com.tencent.smtt.sdk.WebView webView) {
    ...
    @Override
    public void initWebChromeClient(@NonNull com.tencent.smtt.sdk.WebView webView) {
